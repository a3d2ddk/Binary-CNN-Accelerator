set moduleName conv2d_l4_Pipeline_L4_FH_L4_FW
set isTopModule 0
...
set cdfgNum 22
set C_modelName {conv2d_l4_Pipeline_L4_FH_L4_FW}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict output_0 { MEM_WIDTH 1 MEM_SIZE 148 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict output_1 { MEM_WIDTH 1 MEM_SIZE 148 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict output_2 { MEM_WIDTH 1 MEM_SIZE 148 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict output_3 { MEM_WIDTH 1 MEM_SIZE 148 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict output_4 { MEM_WIDTH 1 MEM_SIZE 148 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict output_5 { MEM_WIDTH 1 MEM_SIZE 148 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict output_6 { MEM_WIDTH 1 MEM_SIZE 148 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict output_7 { MEM_WIDTH 1 MEM_SIZE 148 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict output_8 { MEM_WIDTH 1 MEM_SIZE 148 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict output_9 { MEM_WIDTH 1 MEM_SIZE 148 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict output_10 { MEM_WIDTH 1 MEM_SIZE 148 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict output_11 { MEM_WIDTH 1 MEM_SIZE 148 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict output_12 { MEM_WIDTH 1 MEM_SIZE 148 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict output_13 { MEM_WIDTH 1 MEM_SIZE 148 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
...
set C_modelArgList {
	...
	{ sext_ln205 int 16 regular  }
	{ select_ln195 int 4 regular  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln195", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln205", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "select_ln195", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln205 sc_in sc_lv 16 signal 17 } 
	{ select_ln195 sc_in sc_lv 4 signal 18 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln195", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "zext_ln195", "role": "default" }} , 
 	...
 	{ "name": "sext_ln205", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "sext_ln205", "role": "default" }} , 
 	{ "name": "select_ln195", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "select_ln195", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	zext_ln195 { ap_none {  { zext_ln195 in_data 0 8 } } }
	...
	sext_ln205 { ap_none {  { sext_ln205 in_data 0 16 } } }
	select_ln195 { ap_none {  { select_ln195 in_data 0 4 } } }
}
