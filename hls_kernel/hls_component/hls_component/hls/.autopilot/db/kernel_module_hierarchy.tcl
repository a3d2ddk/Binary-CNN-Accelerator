...
"SubInsts" : [
	{"Name" : "grp_kernel_Pipeline_VITIS_LOOP_406_1_fu_821", "RefName" : "kernel_Pipeline_VITIS_LOOP_406_1","ID" : "1","Type" : "sequential",
		"SubLoops" : [
		{"Name" : "VITIS_LOOP_406_1","RefName" : "VITIS_LOOP_406_1","ID" : "2","Type" : "pipeline"},]},],
"SubLoops" : [
	...
	{"Name" : "grp_conv2d_l4_fu_914", "RefName" : "conv2d_l4","ID" : "8","Type" : "sequential",
			"SubInsts" : [
			{"Name" : "grp_conv2d_l4_Pipeline_L4_FH_L4_FW_fu_484", "RefName" : "conv2d_l4_Pipeline_L4_FH_L4_FW","ID" : "9","Type" : "sequential",
				"SubLoops" : [
			...
			{"Name" : "L4_W","RefName" : "L4_W","ID" : "12","Type" : "no",
				...
				{"Name" : "L4_K","RefName" : "L4_K","ID" : "13","Type" : "no",
					"SubInsts" : [
					{"Name" : "grp_conv2d_l4_Pipeline_L4_KH_L4_KW_fu_524", "RefName" : "conv2d_l4_Pipeline_L4_KH_L4_KW","ID" : "14","Type" : "sequential",
							"SubLoops" : [
	...
	{"Name" : "grp_conv2d_l3_fu_984", "RefName" : "conv2d_l3","ID" : "16","Type" : "sequential",
			"SubInsts" : [
			{"Name" : "grp_conv2d_l3_Pipeline_L3_FH_L3_FW_fu_486", "RefName" : "conv2d_l3_Pipeline_L3_FH_L3_FW","ID" : "17","Type" : "sequential",
				"SubLoops" : [
			...
			{"Name" : "L3_W","RefName" : "L3_W","ID" : "20","Type" : "no",
				...
				{"Name" : "L3_K","RefName" : "L3_K","ID" : "21","Type" : "no",
					"SubInsts" : [
					{"Name" : "grp_conv2d_l3_Pipeline_L3_KH_L3_KW_fu_526", "RefName" : "conv2d_l3_Pipeline_L3_KH_L3_KW","ID" : "22","Type" : "sequential",
							"SubLoops" : [
	...
	{"Name" : "grp_conv2d_l2_fu_1054", "RefName" : "conv2d_l2","ID" : "24","Type" : "sequential",
			"SubInsts" : [
			{"Name" : "grp_conv2d_l2_Pipeline_L2_FH_L2_FW_fu_486", "RefName" : "conv2d_l2_Pipeline_L2_FH_L2_FW","ID" : "25","Type" : "sequential",
				"SubLoops" : [
			...
			{"Name" : "L2_W","RefName" : "L2_W","ID" : "28","Type" : "no",
				...
				{"Name" : "L2_K","RefName" : "L2_K","ID" : "29","Type" : "no",
					"SubInsts" : [
					{"Name" : "grp_conv2d_l2_Pipeline_L2_KH_L2_KW_fu_526", "RefName" : "conv2d_l2_Pipeline_L2_KH_L2_KW","ID" : "30","Type" : "sequential",
							"SubLoops" : [
	...
	{"Name" : "grp_conv2d_l1_fu_1124", "RefName" : "conv2d_l1","ID" : "32","Type" : "sequential",
			"SubInsts" : [
			{"Name" : "grp_conv2d_l1_Pipeline_INIT_FH_INIT_FW_fu_468", "RefName" : "conv2d_l1_Pipeline_INIT_FH_INIT_FW","ID" : "33","Type" : "sequential",
				"SubLoops" : [
			...
			{"Name" : "INIT_W","RefName" : "INIT_W","ID" : "36","Type" : "no",
				...
				{"Name" : "INIT_K","RefName" : "INIT_K","ID" : "37","Type" : "no",
					"SubInsts" : [
					{"Name" : "grp_conv2d_l1_Pipeline_INIT_KH_INIT_KW_fu_508", "RefName" : "conv2d_l1_Pipeline_INIT_KH_INIT_KW","ID" : "38","Type" : "sequential",
							"SubLoops" : [
