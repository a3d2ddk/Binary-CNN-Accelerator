...
//Date        : Sat May  2 00:13:29 2026
//Host        : oldak-ZenBook-UX325EA-UX325EA running 64-bit Ubuntu 22.04.5 LTS
//Command     : generate_target cnn_accel.bd
//Design      : cnn_accel
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "cnn_accel,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=cnn_accel,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=9,da_ps7_cnt=2,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "cnn_accel.hwdef" *) 
module cnn_accel
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  cnn_accel_axi_dma_0_0 axi_dma_0
  ...
  cnn_accel_axi_smc_1_0 axi_smc_1
       (.M00_AXI_araddr(axi_smc_1_M00_AXI_ARADDR),
        ...
        .aclk(processing_system7_0_FCLK_CLK0),
        .aresetn(rst_ps7_0_76M_peripheral_aresetn));
  cnn_accel_axi_smc_2_0 axi_smc_2
  ...
  cnn_accel_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
        ...
        .S_AXI_HP1_AWADDR(axi_smc_2_M00_AXI_AWADDR),
        .S_AXI_HP1_AWBURST(axi_smc_2_M00_AXI_AWBURST),
        .S_AXI_HP1_AWCACHE(axi_smc_2_M00_AXI_AWCACHE),
        .S_AXI_HP1_AWID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP1_AWLEN(axi_smc_2_M00_AXI_AWLEN),
        .S_AXI_HP1_AWLOCK(axi_smc_2_M00_AXI_AWLOCK),
        .S_AXI_HP1_AWPROT(axi_smc_2_M00_AXI_AWPROT),
        .S_AXI_HP1_AWQOS(axi_smc_2_M00_AXI_AWQOS),
        .S_AXI_HP1_AWREADY(axi_smc_2_M00_AXI_AWREADY),
        .S_AXI_HP1_AWSIZE(axi_smc_2_M00_AXI_AWSIZE),
        .S_AXI_HP1_AWVALID(axi_smc_2_M00_AXI_AWVALID),
        .S_AXI_HP1_BREADY(axi_smc_2_M00_AXI_BREADY),
        .S_AXI_HP1_BRESP(axi_smc_2_M00_AXI_BRESP),
        .S_AXI_HP1_BVALID(axi_smc_2_M00_AXI_BVALID),
        .S_AXI_HP1_RDISSUECAP1_EN(1'b0),
        .S_AXI_HP1_RREADY(1'b0),
        .S_AXI_HP1_WDATA(axi_smc_2_M00_AXI_WDATA),
        .S_AXI_HP1_WID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP1_WLAST(axi_smc_2_M00_AXI_WLAST),
        .S_AXI_HP1_WREADY(axi_smc_2_M00_AXI_WREADY),
        .S_AXI_HP1_WRISSUECAP1_EN(1'b0),
        .S_AXI_HP1_WSTRB(axi_smc_2_M00_AXI_WSTRB),
        .S_AXI_HP1_WVALID(axi_smc_2_M00_AXI_WVALID),
        .USB0_VBUS_PWRFAULT(1'b0));
  cnn_accel_rst_ps7_0_76M_0 rst_ps7_0_76M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
